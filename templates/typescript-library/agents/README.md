...
This directory contains custom agents compatible with GitHub Copilot, Claude, Cursor, and other AI assistants. This template includes all SDLC phase agents plus the TypeScript Library specialist for complete self-contained functionality.
...
1. **TypeScript Library Specialist** (`typescript-library-specialist.agent.md`)
   - Dual ESM/CJS exports with tree-shaking optimization
   - NPM publishing workflow with Changesets
   - Type definition management and declaration files
...
- Use the TypeScript Library specialist agent for this template
...
- You have the TypeScript Library specialist agent
