# React Router SSR Template

A modern, production-ready template for building server-side rendered React applications with React Router, featuring type-safe i18n, comprehensive testing, and excellent developer experience.

## ✨ Features

- **🔄 React Router** - Latest React Router with SSR mode and type-safe routing
...
2. Use React Router file-based routing conventions
