...
# React Router SSR Template Setup Script
# This script automates the initial setup process for the React Router SSR template
#
...
# Configuration
readonly TEMPLATE_NAME="React Router SSR Template"
