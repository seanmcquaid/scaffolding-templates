...
This directory contains custom agents compatible with GitHub Copilot, Claude, Cursor, and other AI assistants. This template includes all SDLC phase agents plus the React Router SSR specialist for complete self-contained functionality.
...
1. **React Router SSR Specialist** (`react-router-ssr-specialist.agent.md`)
...
- Use the React Router SSR specialist agent for this template
...
- You have the React Router SSR specialist agent
