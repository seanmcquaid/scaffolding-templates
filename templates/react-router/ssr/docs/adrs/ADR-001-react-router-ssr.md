# ADR-001: Use React Router for SSR
...
We will use **React Router** with server-side rendering capabilities as the foundation for this SSR template.

## Rationale

React Router with SSR provides:
...
- **Risk**: React Router SSR is relatively new
...
- **Cons**: 
  - React Router is the evolution of Remix
  - Remix is being merged into React Router
- **Reason for rejection**: React Router is the future of Remix
...
- **Description**: Use SPA-only approach (see react-router/spa template)
- **Pros**: 
