...
A modern, production-ready template for building single-page applications with React Router, featuring type-safe i18n, comprehensive testing, and excellent developer experience.

## ✨ Features

- **🔄 React Router** - Latest React Router with SPA mode and type-safe routing
