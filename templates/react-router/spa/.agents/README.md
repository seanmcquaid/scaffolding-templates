...
This directory contains custom agents compatible with GitHub Copilot, Claude, Cursor, and other AI assistants. This template includes all SDLC phase agents plus the React Router SPA specialist for complete self-contained functionality.
...
1. **React Router SPA Specialist** (`react-router-spa-specialist.agent.md`)
...
- Use the React Router SPA specialist agent for this template
...
- You have the React Router SPA specialist agent
