# ADR-001: Use React Router for SPA
...
We will use **React Router** as the routing framework for this single-page application template.
...
- Learning curve for developers unfamiliar with React Router
...
- **Risk**: React Router is relatively new
...
- Leverage React Router's type generation for type-safe routing
...
- [React Router Release Notes](https://remix.run/blog/react-router-v7)
