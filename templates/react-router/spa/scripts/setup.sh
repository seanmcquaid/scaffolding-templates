...
# React Router SPA Template Setup Script
# This script automates the initial setup process for the React Router SPA template
#
...
# Configuration
readonly TEMPLATE_NAME="React Router SPA Template"
