...
This directory contains custom agents compatible with GitHub Copilot, Claude, Cursor, and other AI assistants. This template includes all SDLC phase agents plus the Expo React Native specialist for complete self-contained functionality.
...
1. **Expo React Native Specialist** (`expo-react-native-specialist.agent.md`)
...
- Use the Expo React Native specialist agent for this template
