...
1. **Title**: A short, descriptive title (e.g., "ADR-001: Use Expo")
...
- [ADR-005: Testing Strategy with Jest](./ADR-005-testing-strategy.md)
- [ADR-006: State Management Approach](./ADR-006-state-management.md)
- [ADR-007: API Client with ky and Zod](./ADR-007-api-client.md)
- [ADR-008: Form Handling with React Hook Form](./ADR-008-form-handling.md)
- [ADR-009: Code Quality Tooling](./ADR-009-code-quality.md)
