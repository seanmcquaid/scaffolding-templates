# Skills for react-router-v7-ssr Template

This directory contains agent skills for the react-router-v7-ssr template. These skills work with GitHub Copilot, Claude Code, Cursor, and 20+ other AI coding agents.
...
- **react-router-ssr** - Specialized for this template (`./react-router-ssr/SKILL.md`)
