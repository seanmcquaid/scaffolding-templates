...
# TanStack Start Template Setup Script
# This script automates the initial setup process for the TanStack Start template
#
...
# Configuration
readonly TEMPLATE_NAME="TanStack Start Template"
...
show_completion_message() {
    ...
    echo "   pnpm dev                     - Start development server (SSR)"
