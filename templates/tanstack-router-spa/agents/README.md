...
This directory contains custom agents compatible with GitHub Copilot, Claude, Cursor, and other AI assistants. This template includes all SDLC phase agents plus the TanStack Router SPA specialist for complete self-contained functionality.
...
1. **TanStack Router SPA Specialist** (`tanstack-router-spa-specialist.agent.md`)
   - Type-safe routing with generated route types
...
- Use the TanStack Router SPA specialist agent for this template
...
- You have the TanStack Router SPA specialist agent
